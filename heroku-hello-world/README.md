...
launch from the command line:
    ...
    $ lein run -m heroku-hello-world.web
...
get the app created:
    ...
    $ heroku apps:create heroku-hello-world
    Creating heroku-hello-world... done, stack is cedar
    http://heroku-hello-world.herokuapp.com/ | git@heroku.com:heroku-hello-world.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://heroku-hello-world.herokuapp.com deployed to Heroku

    To git@heroku.com:heroku-hello-world.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://heroku-hello-world.herokuap.com
    ["Hello" :from Heroku]
